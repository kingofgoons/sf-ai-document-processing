...
-- Phase 3 objects (reverse dependency order)
DROP AGENT IF EXISTS LEASE_INTELLIGENCE_AGENT;
DROP SEMANTIC VIEW IF EXISTS LEASE_ANALYTICS_VIEW;
DROP CORTEX SEARCH SERVICE IF EXISTS LEASE_SEARCH_SERVICE;
DROP TABLE IF EXISTS LEASE_SEARCH_CORPUS;
